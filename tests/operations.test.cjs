...
function fixture(){
 ...
 for(const ss of [books.A,books.B]){ctx.ensureCompanySheets_(ss);ctx.appendObjectRow_(ss.getSheetByName('Агуулах'),{'Агуулахын нэр':'Main'});ctx.appendObjectRow_(ss.getSheetByName('Агуулах'),{'Агуулахын нэр':'Other'});ctx.appendObjectRow_(ss.getSheetByName('Байршил'),{'Байршлын нэр':'Main'});ctx.appendObjectRow_(ss.getSheetByName('Бараа'),{'Барааны нэр':'Bread',ProductID:'PRD-BREAD','Нэгж үнэ':100,'Одоогийн үлдэгдэл':100,'Хэмжих нэгж':'ш','Идэвхтэй':true,PackSize:12,PackName:'Box'});ctx.appendObjectRow_(ss.getSheetByName('Бараа'),{'Барааны нэр':'Cake',ProductID:'PRD-CAKE','Нэгж үнэ':200,'Одоогийн үлдэгдэл':50,'Хэмжих нэгж':'ш','Идэвхтэй':true});}
