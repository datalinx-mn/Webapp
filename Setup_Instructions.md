> Өдөр тутмын ажиллагааны шинэ багцад [DAILY_OPERATIONS_SETUP_MN.md](DAILY_OPERATIONS_SETUP_MN.md)-ийн файлын жагсаалт болон дарааллыг ашиглана. Доорх нь өмнөх PDF хувилбарын дэлгэрэнгүй заавар.
